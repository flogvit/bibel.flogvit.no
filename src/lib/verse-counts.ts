// Auto-generated by scripts/generate-verse-counts.ts — do not edit manually
...
export const verseCounts: Record<number, number[]> = {
  ...
  12: [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 20, 22, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30],
  ...
  16: [11, 20, 38, 17, 19, 19, 72, 18, 37, 40, 36, 47, 31],
  ...
  45: [32, 29, 31, 25, 21, 23, 25, 39, 33, 21, 36, 21, 14, 23, 33, 24],
